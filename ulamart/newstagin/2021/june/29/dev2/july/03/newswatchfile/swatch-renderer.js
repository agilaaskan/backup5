    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderSwatchOptions: function (config, controlId, $widget) {
            ...
            $.each(config.options, function (index) {
                ...
                if (type === 0) {
                    // Text
                    var cprice = $widget.optionsMap[config.id][id]['price']; 
                    cprice = Math.round(cprice);  
                    html += '<div class="' + optionClass + ' text" ' + attr + '><span>' + (value ? value : label) +
                    '</span><div class="custom-option-price">₹' + cprice + '</div>'+
                        '</div>';
                } else if (type === 1) {
                    // Color
        ...
        _Rewind: function (controls) {
            ...
            controls.find('div[data-option-empty], option[data-option-empty]').attr('disabled', true).addClass('disabled');
        },
