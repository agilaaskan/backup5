            ...
            $ptn = "/^0/";
                ...
                $results = $connection->fetchAll($sqls);
                    ...
                    if (!empty($checkid)) {
                            ...
                            $checkname =  $customerObj->getFirstname(); // get Id
                            $sqls1 = "SELECT sales_order_address.region_id,sales_order_address.telephone,sales_order_grid.payment_method FROM sales_order_grid INNER JOIN sales_order_address ON sales_order_grid.entity_id = sales_order_address.parent_id WHERE sales_order_grid.increment_id = '$curorderid' LIMIT 1";
