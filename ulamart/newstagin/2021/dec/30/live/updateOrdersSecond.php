            ...
            for ($k = 0;$k < count($weightList);$k++)
            {
                $totalboxwt = $totalboxwt + floatval($weightList[$k]->weight);
                    ...
                    if($old_mail_status != 1)
                    {
                        ...
                        if (send_email($customer_email, $attachment, $message, $order_id, $consinment, $telephone, $checkname, $checkem, $tracking ,$total_bx ,$totalboxwt,$event))
                        {
...
function send_email($to, $attachment, $message, $order_number, $consinment, $telephone, $checkname, $checkem, $tracking ,$total_bx ,$totalboxwt,$event)
{
