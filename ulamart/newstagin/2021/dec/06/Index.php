...
protected $resultJsonFactory; 
    ...
    { 
        ...
        // }
            ...
            $returnvalue['status']="1";
            $returnvalue['pname']= $product->getName();
            $returnvalue['pidd']= $product->getId();
            $returnvalue['pprice']= $product->getFinalPrice();
            $returnvalue['subtotal']= $subTotal;
            $returnvalue['grandtotal']= $grandTotal;
